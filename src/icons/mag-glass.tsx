...
export const MagGlass = ({height, width, style, fillColor, lineColor}: CustomIconProps) => {
  return (
    <div style={style ? style : {}}>
      <svg xmlns="http://www.w3.org/2000/svg" height="100%" width="100%" viewBox={`0 0 40 40`} fill={fillColor} stroke={lineColor}>
